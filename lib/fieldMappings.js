...
const mappings = {
  ...
  opsgenie: useSharedMappings(['v2', 'v2.1'], mapToUsing('opsgenie', passThru)),
  pagerduty: useSharedMappings(
    ['v2', 'v2.1'],
    mapToUsing('pagerduty', passThru),
  ),
}
 ...
 * @type {string[]}
 **/
const schemaFields = _.omit(_.keys(mappings), convenienceFields)
