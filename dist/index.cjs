...
module.exports = eval("require")("./lib/input-to-registry-document");
...
module.exports = eval("require")("./lib/input-validation");
...
module.exports = eval("require")("./lib/org-rules");
...
const { inputsToRegistryDocument } = __nccwpck_require__(771)
const { validateDatadogHostname } = __nccwpck_require__(378)
const { fetchAndApplyOrgRules } = __nccwpck_require__(335)
